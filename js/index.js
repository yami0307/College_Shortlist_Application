...
function anotherPage() {
    ...
    if (
      ...
      if (flag) {
        document.getElementById(
          "title"
        ).innerHTML = `<h1>Congratulations! These are the best colleges available for you</h1>`;
      ...
      if (
        ...
        if (flag) {
          ...
          document.getElementById(
            "title"
          ).innerHTML = `<h1>Congratulations! These are some colleges available for you</h1>`;
          let headerRow = document.createElement("tr");
          headers.forEach((headerText) => {
            let header = document.createElement("th");
            let textNode = document.createTextNode(headerText);
  ...
  if (count == 0) {
    document.getElementById(
      "title"
    ).innerHTML = `<h1>Sorry no colleges are available for you!</h1>`;
  }
}
